...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "Multiple tool calls (one after another):",
    '<tool_call id="call_001" name="read">',
    '{"file_path":"/path/to/file1.txt"}',
    '<tool_call id="call_002" name="exec">',
    '{"command":"ls -la /tmp"}',
    "",
    "CRITICAL rules:",
    "- Tool names are CASE-SENSITIVE and must match exactly as listed in Tool availability.",
    "- Arguments MUST be valid JSON inside the XML tags.",
    "- Each tool call needs a unique `id` (e.g., `call_001`, `call_002`, etc.).",
    "- Do NOT wrap tool calls in code blocks or markdown.",
    "- Do NOT describe what tool you'll use — just output the XML directly.",
    "- After calling a tool, wait for the response before proceeding.",
    "",
    ...safetySection,
