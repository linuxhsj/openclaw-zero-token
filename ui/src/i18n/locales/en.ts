...
export const en: TranslationMap = {
  ...
  config: {
    ...
    noResults: "No matching configuration items found.",
    rawMode: "Raw Mode",
    formMode: "Form Mode",
    unsupportedField: "Unsupported field type. Use Raw mode.",
    ...
    sectionLoading: "Loading configuration...",
    largeSectionPlaceholder: "This section has {count} fields. Click to load...",
    tags: "Tags",
    selectPlaceholder: "Select...",
    numberDecrement: "Decrement",
